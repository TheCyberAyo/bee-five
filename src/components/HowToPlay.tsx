...
export default function HowToPlay({ onBackToMenu, isMobile }: HowToPlayProps) {
  return (
    <div style={{ 
      ...
      <div style={{
        ...
        <div style={{
          ...
          <ul style={{
            ...
            <li style={{ marginBottom: '0.75rem' }}>
              The goal is to connect five in a row — horizontally, vertically, or diagonally.
            </li>
            <li style={{ marginBottom: '0.75rem' }}>
              The first to make a line of five wins!
            </li>
          </ul>

          <p style={{ marginBottom: '2rem' }}>
            It's quick to learn but tricky to master — just like any great game of strategy!
          </p>
