const List<String> beeFacts = [
  "Bees have been around for more than 30 million years!",
  "A honey bee can fly up to 24km per hour.",
  "Bees need roughly 10.5 million flowers to make 1 litre of honey",
  "A bee colony can produce about 27-45 kgs of honey per year",
  "Bees have 5 eyes: 3 simple eyes on top and 2 compound eyes.",
  "Worker bees are all female and do all the work in the hive.",
  "Male bees (drones) have one purpose: to mate with the queen.",
  ...
  "Honey bees must consume about 8kg of honey to produce 1kg of beeswax.",
  ...
  "Bees keep their hive at a constant 34 C year-round.",
  ...
  "Bees evaporate water from nectar by fanning their wings over it.",
  ...
  "Bees collect nectar from flowers up to 8 kilometers from the hive.",
  ...
  "Beeswax has a melting point of 62-64 C.",
  "Bees must eat honey to produce wax from special glands.",
  "It takes about 8 kg of honey to produce 1 kg of beeswax",
  ...
  "A single honeycomb can hold up to 1.82 kg of honey!",
  ...
  "Solitary bees (like mason bees) do not live in colonies.",
  ...
  "Bees can raise their body temperature to 47 C to kill hornets.",
  ...
  "European honey bees do not have this defense mechanism.",
  ...
  "The economic value of bee pollination is 15-20 billion USD annually in the US.",
  "Worldwide, bee pollination is worth 200 billion USD per year!",
...
String? getBeeFactForGame(int gameNumber) {
  if (gameNumber < 1 || beeFacts.isEmpty) {
    return null;
  }

  // Show facts only on levels ending with 1 (1, 11, 21, ...).
  if (gameNumber % 10 != 1) {
    return null;
  }

  // Advance one fact per qualifying level and loop when out of range.
  final factIndex = ((gameNumber - 1) ~/ 10) % beeFacts.length;
  return _stripEmoji(beeFacts[factIndex]);
}
