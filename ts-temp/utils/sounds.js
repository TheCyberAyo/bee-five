...
class SoundGenerator {
    constructor() {
        ...
        this.volume = 0.3;
        this.isMuted = false; // Sounds enabled by default
    ...
    initAudioContext() {
        ...
        if (!this.audioContext) {
            try {
                ...
                const AudioContextConstructor = (_a = extendedWindow.AudioContext) !== null && _a !== void 0 ? _a : extendedWindow.webkitAudioContext;
